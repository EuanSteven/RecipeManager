...
<head>
  ...
  <title>Recipe Manager | Scan</title>

  <meta property="og:title" content="Recipe Manager | Scan">
  <meta property="og:type" content="website">
  <meta property="og:image" content="/assets/images/covers/scan_cover.jpg">
...
<body>
  ...
  <div class="upload-box">
    <h3>Upload Image</h3>
    <p>Choose files in .jpg, .png or .pdf format</p>
    <button class="add-button">Choose files</button>
    <br>
